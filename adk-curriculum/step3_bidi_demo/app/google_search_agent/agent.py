...
agent = Agent(
    ...
    tools=[google_search],
    instruction=(
        "You are a helpful assistant that can search the web and analyze the user's "
        "live continuous video stream. You can see through their camera. Answer questions "
